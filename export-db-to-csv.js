...
const entityMappings = [
    ...
    { entity: 'skillsphere.Employees', file: 'skillsphere-Employees.csv', columns: ['employeeId', 'name', 'team', 'subTeam', 'managerId', 'email', 'experience', 'totalSkills', 'totalProjects', 'role', 'location', 'tLevel'] },
    ...
    { entity: 'skillsphere.Projects', file: 'skillsphere-Projects.csv', columns: ['projectId', 'employeeId', 'projectName', 'role', 'startDate', 'endDate', 'status', 'description', 'duration', 'projectManager', 'accountExecutiveManager', 'lineManagerPOC', 'projectOrchestrator'] },
    { entity: 'skillsphere.Profiles', file: 'skillsphere-Profiles.csv', columns: ['employeeId', 'specialization', 'role', 'location', 'tLevel', 'lastUpdated'] },
    ...
    { entity: 'skillsphere.Certifications', file: 'skillsphere-Certifications.csv', columns: ['certificationId', 'employeeId', 'certificationName', 'issuingOrganization', 'issueDate', 'expiryDate', 'credentialId', 'status'] }
];
